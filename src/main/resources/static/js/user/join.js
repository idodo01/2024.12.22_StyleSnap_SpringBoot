...
let telAuthCompleted = false; // 이메일 인증 여부
let emailAuthCompleted = false; // 이메일 인증 여부
IMP.init("imp34343376"); // Portone 모듈 초기화
/************************************************************************/
// id 중복 체크 버튼 클릭 시
idCheckBtn.onclick = () => {
...
telAuthBtn.onclick = () => {
    IMP.certification({
            channelKey: "channel-key-9ec40bb4-6415-4571-922d-7c18e4fa51e6",
            merchant_uid: "a", // 주문 번호
        },
